...
/** @type {import('process-warning').Warning} Schema missing for a route */
...
/** @type {import('process-warning').Warning} Mixed async/callback hook */
...
/** @type {import('process-warning').Warning} Error handler override in same scope */
...
/** @type {import('process-warning').Warning} Regex Content-Type CORS vulnerability */
...
/** @type {import('process-warning').Warning} Deprecated direct router option access */
