 ...
 */
function reqIdGenFactory (requestIdHeader, optGenReqId, requestIdPrefix) {
  var genReqId = optGenReqId || buildDefaultGenReqId(requestIdPrefix)
...
function buildDefaultGenReqId (prefix) {
  ...
  return function defaultGenReqId () {
    ...
    return `${p}-${nextReqId.toString(36)}`
  }
}
